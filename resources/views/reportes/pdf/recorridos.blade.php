...
<head>
  ...
  <style>
    * { font-family: DejaVu Sans, sans-serif; }
    ...
    .header { border-bottom: 3px solid #0e8f68; padding-bottom: 10px; margin-bottom: 16px; }
    .brand { color: #0e8f68; font-size: 20px; font-weight: bold; }
    ...
    .stat-num { font-size: 20px; font-weight: bold; color: #0e8f68; }
    .stat-label { color: #5d6b75; font-size: 9px; }
    h2 { font-size: 13px; color: #076348; border-bottom: 1px solid #dfe5e5; padding-bottom: 4px; margin: 14px 0 8px; }
    ...
    .codigo { display: inline-block; background: #dceef2; color: #0b7285; padding: 1px 6px; border-radius: 8px; font-size: 9px; font-weight: bold; }
